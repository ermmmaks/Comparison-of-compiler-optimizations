...
main:        .cfi_startproc        pushq    %rbp
    ...
    movl    i2, %eax
    cmpl    j4, %eax
    jge    .LBB0_3        movl    i4, %eax
    cmpl    j4, %eax
    jge    .LBB0_3        movl    $2, i2
    movl    i2, %esi
    movabsq    $.L.str, %rdi
    movb    $0, %al
    callq    printf
.LBB0_3:
    ...
    movl    i2, %eax
    cmpl    j4, %eax
    jge    .LBB0_6        movl    i4, %eax
    cmpl    j4, %eax
    jge    .LBB0_6        movl    $3, i5
    movl    i5, %esi
    movabsq    $.L.str, %rdi
    movb    $0, %al
    callq    printf
.LBB0_6:
    movl    $3, i3
    movsd    .LCPI0_2(%rip), %xmm0        movsd    %xmm0, flt_1
    movl    $5, i2
    movl    i, %eax
    addl    $0, %eax
    movl    %eax, j2
    ...
    movb    $0, %al
    callq    printf
    movsd    .LCPI0_1(%rip), %xmm0        movsd    %xmm0, flt_3
    movsd    .LCPI0_0(%rip), %xmm0        movsd    %xmm0, flt_4
    xorps    %xmm0, %xmm0
    mulsd    flt_6, %xmm0
    movsd    %xmm0, flt_5
    movsd    flt_2, %xmm0        mulsd    flt_3, %xmm0
    movsd    %xmm0, flt_6
    movl    $1, k3
    movl    $1, k3
    movl    j5, %eax
    ...
    movl    $0, i
.LBB0_7:        cmpl    $5, i
    jg    .LBB0_10        movl    i, %eax
    shll    %eax
    movw    %ax, %cx
    movslq    i, %rax
    movw    %cx, ivector4(,%rax,2)        movl    i, %eax
    addl    $1, %eax
    movl    %eax, i
    jmp    .LBB0_7
.LBB0_10:
    movl    $0, j5
    movl    $10000, k5    .LBB0_11:        movl    k5, %eax
    subl    $1, %eax
    movl    %eax, k5
    movl    j5, %eax
    addl    $1, %eax
    ...
    cltd
    idivl    %ecx
    movl    %eax, i5        cmpl    $0, k5
    jg    .LBB0_11        movl    $0, i
.LBB0_14:        cmpl    $100, i
    jge    .LBB0_17        movl    i, %eax
    shll    %eax
    addl    $3, %eax
    cltq
    movl    $5, ivector5(,%rax,4)        movl    i, %eax
    addl    $1, %eax
    movl    %eax, i
    jmp    .LBB0_14
.LBB0_17:
    cmpl    $10, i
    jge    .LBB0_19        movl    i5, %eax
    addl    i2, %eax
    movl    %eax, j5
    jmp    .LBB0_20
.LBB0_19:
